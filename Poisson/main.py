...
class sequential_model(nn.Module):
    ...
    def function(self, x):
        ...
        f = (
            ...
            + u_yy
            + 200 * ex1
            - 40000 * torch.square(x_ - 0.8) * ex1
            - (200 * ey1 - 40000 * torch.square(y_ - 0.8) * ey1)
            + 200 * ex2
            - 40000 * torch.square(x_ + 0.8) * ex2
            - (200 * ey2 - 40000 * torch.square(y_ + 0.8) * ey2)
            + 200 * ex3
            - 40000 * torch.square(x_) * ex3
            - (200 * ey3 - 40000 * torch.square(y_) * ey3)
        )
        return f
